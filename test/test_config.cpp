...
#define XX_PM(g_var, prefix)                                                                                \
    ...
    XX_PM(g_person_map, "g_person_map before");
    ...
    SYLAR_LOG_INFO(SYLAR_LOG_ROOT()) << "g_person after : " << g_person->getValue().toString() << " - " << g_person->toString();
    XX_PM(g_person_map, "g_person_map after");
    SYLAR_LOG_INFO(SYLAR_LOG_ROOT()) << "g_person_vec_map after : "<<g_person_vec_map->toString() ;
